...
{
    [TestFixture]
    public class GameManagementModeratorControllerTests
    {
        ...
        private GameManagementModeratorController controller;
        ...
        public void SetUp()
        {
            ...
            controller = new GameManagementModeratorController(
