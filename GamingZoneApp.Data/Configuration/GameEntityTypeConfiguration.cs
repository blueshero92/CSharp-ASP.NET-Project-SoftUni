...
namespace GamingZoneApp.Data.Configuration
{
    public class GameEntityTypeConfiguration : IEntityTypeConfiguration<Game>
    {
        ...
        public void Configure(EntityTypeBuilder<Game> entity)
        {
            ...
            //Set the relationship between Game and User to Restrict to avoid multiple cascade delete paths when deleting a user.
        ...
        private readonly IEnumerable<Game> games = new List<Game>()
        {
            new Game
            {
                ...
                ImageUrl = "/images/game/bloodlightSanatorium.png",
            ...
            new Game
            {
                ...
                ImageUrl = "/images/game/oathVermilionRonin.png",
                UserId = Guid.Parse("e303f8ff-8c3d-4ec7-bdc9-bc5efa05325f")
            },
            new Game
            {
                ...
                ImageUrl = "/images/game/ravencrest.png",
                UserId = Guid.Parse("e303f8ff-8c3d-4ec7-bdc9-bc5efa05325f")
            },
            new Game
            {
                ...
                ImageUrl = "/images/game/gearwrightCaverns.png",
                UserId = Guid.Parse("e303f8ff-8c3d-4ec7-bdc9-bc5efa05325f")
            },
            new Game
            {
                ...
                ImageUrl = "/images/game/wanderers.png",
                UserId = Guid.Parse("e303f8ff-8c3d-4ec7-bdc9-bc5efa05325f")
            },
            new Game
            {
                ...
                ImageUrl = "/images/game/galacticCrusadersII.png",
                UserId = Guid.Parse("e303f8ff-8c3d-4ec7-bdc9-bc5efa05325f")
            }
        };
