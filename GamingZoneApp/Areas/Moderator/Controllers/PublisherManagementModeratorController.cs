...
{
    public class PublisherManagementModeratorController : BaseModeratorController
    {
        private readonly IPublisherService publisherService;
        private readonly IPublisherManagementService publisherManagementService;

        public PublisherManagementModeratorController(IPublisherService publisherService, IPublisherManagementService publisherManagementService)
        {
