...
{
    public class GameManagementModeratorController : BaseModeratorController
    {
        ...
        public GameManagementModeratorController(IGameService gameService, IGameManagementService gameManagementService,
