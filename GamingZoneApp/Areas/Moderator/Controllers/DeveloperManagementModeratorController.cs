...
{
    public class DeveloperManagementModeratorController : BaseModeratorController
    {
        private readonly IDeveloperService developerService;
        private readonly IDeveloperManagementService developerManagementService;

        public DeveloperManagementModeratorController(IDeveloperService developerService, IDeveloperManagementService developerManagementService)
        {
